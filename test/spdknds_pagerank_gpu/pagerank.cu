...
__global__ void pagerank_update(double* prev_pr, double* curr_pr, double *vertices, size_t st, int64_t* inedges, int64_t *outedges, int num_of_vertices, int num_of_subvertices, int iter, int niters) {
